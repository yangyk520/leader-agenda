<template>
  ...
  <div idm-ctrl="idm_module"
   ...
   <div class="scroll_block">
    ...
    <template v-else>
      <AgendaTableList @updateTableData="updateTableData" :data_list_table="data_list_table" :header_list_table="header_list_table" :setting_data="setting_data"></AgendaTableList>
    </template>
   </div>
