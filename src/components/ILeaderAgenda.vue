<template>
  ...
  <div idm-ctrl="idm_module"
   ...
   <div class="scroll_block">
    <AgendaHeader :moduleObject="moduleObject" :scheduleType="setting_data.scheduleType" :isPreview="isPreview" :viewModel="setting_data.viewModel" :leaderImageShow="setting_data.leaderImageShow"  @updateHeadParams="updateHeadParams" @updateSetting="updateSetting" />
    ...
    <template v-else>
      <AgendaTableList @updateTableData="updateTableData" :isPreview="isPreview" :data_list_table="data_list_table" :header_list_table="header_list_table" :setting_data="setting_data"></AgendaTableList>
    </template>
   </div>
   <AgendaFooter v-if="setting_data.iconDescShow === 0" :isPreview="isPreview" :setting_data="setting_data" :propData="propData"></AgendaFooter>
  </div>
</template>
